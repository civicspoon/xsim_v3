    ...
    return (
        <div className="flex flex-col h-screen w-screen bg-[#050505] text-white tracking-tighter font-sans overflow-hidden">
            ...
            <div className="h-24 bg-[#0d0d0d] flex items-center justify-around border-t border-white/10 px-12">
                ...
                <button onClick={() => router.push("/xsim3/pages/dashboard")} className="bg-red-600/10 border border-red-600/20 px-6 py-3 rounded-xl text-xs font-black hover:bg-red-600 uppercase transition-all">Abort Mission</button>
            </div>
        </div>
    );
}